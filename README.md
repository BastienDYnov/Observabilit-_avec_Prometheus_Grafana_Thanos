...
![image.png](attachment:073b9166-1095-4e8e-94f7-a24f8034dbc8:image.png)
...
![image.png](attachment:b4fd1691-490a-4475-aae7-2755b0d3d3af:image.png)

1. Ouvrir http://localhost:9090 dans votre navigateur :

![image.png](attachment:8ae68035-0aca-47be-ac03-b2b918651654:image.png)

1. Aller dans Status > Targets et confirmer que la cible prometheus est UP :

![image.png](attachment:99c19195-59bb-4027-a988-acc035e1fb3f:image.png)

1.  Exécuter docker logs prometheus et lire la ligne de démarrage qui annonce le répertoire de stockage :

d’après ce que jevois dans les logs, le seul endroit de stockage qui nous est donnée est “/etc/prometheus/”

![image.png](attachment:062ca193-ad5e-4f11-b877-08ae4340f7f6:image.png)
...
1. créer un fichier prometheus.yml sur l’hôte avec le fichier monté sur “/etc/prometheus/prometheus.yml” avec les paramètres demander :
...
1. J’ai lancer le nouveau conteneur : 

```bash
docker compose up -d
```

![image.png](attachment:10531a7b-092d-4c27-8df1-56d3aaefc90c:image.png)

![image.png](attachment:d3c3a01d-1e57-4966-a7fb-7c7dee2881ca:image.png)

1. j’ai modifier le fichier et déclencher un rechargement:
...
![image.png](attachment:35120e36-d01d-4011-ae65-8b71d9cccdd6:image.png)
...
![image.png](attachment:18125748-3ce4-4e3e-88ec-87c7361d4b12:image.png)

1. J’ai ajouter un nouveau job pour le node dans prometheus.yml :
...
1. J’ai déclencher un rechargement avec : 

```bash
curl -X POST http://localhost:9090/-/reload
```

![image.png](attachment:590c8d0e-fe51-47d5-8505-78752f790c72:image.png)

1. j’ai exécuter la requête “node_cpu_seconds_total” et j’ai eu ce résultat :

![image.png](attachment:19b8b856-fa69-43f0-80a6-af3cc0e8bc00:image.png)

![image.png](attachment:b517eeca-c9f9-4ca4-ba0e-dc6d75f5b403:image.png)
...
1. je l’ai mis dans un dossier sd : 
...
1. J’ai modifier le fichier prometheus.yml pour remplacer les static_configs : 
...
![image.png](attachment:d6144f6c-ab7a-4328-b994-110f83705384:image.png)

![image.png](attachment:fed0b904-01b8-4f60-af7e-7bfebea955cc:image.png)

1. Maintenant on vas ajouter ou retirer une cible JSON et voila ce qu’il ce passe :
...
![image.png](attachment:041109fe-efed-4500-a5dd-b884786df3ab:image.png)
...
![image.png](attachment:b77d3682-2162-478c-b0ff-2bf68c75ac22:image.png)
...
![image.png](attachment:851e586b-0f20-4db9-b89f-28c62cf7de69:image.png)

![image.png](attachment:98f733f9-92e6-4d0f-adb1-88f35a4bc2c8:image.png)
...
1. Je rajoute la rule_file dans “/etc/prometheus/rules/*.yml”
...
![image.png](attachment:1f7680c4-1759-4ae5-9862-58a8d2aeb437:image.png)

On vois que dans les rules sur l’interface web de prometheus il y à ma règle :

![image.png](attachment:17572b08-ddf5-418a-8b99-d404fcca1571:image.png)
...
![image.png](attachment:a71da7b4-3a64-403f-aa76-3bbecd34ed1d:image.png)
